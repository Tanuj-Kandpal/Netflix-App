...
function HomePage() {
    ...
    function HeadingLanguage({ heading1, heading2, heading3 }) {
        return <div className="flex flex-col justify-center text-center items-center h-96">
