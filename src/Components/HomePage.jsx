...
function HomePage() {
    ...
    function HeadingLanguage({ heading1, heading2, heading3 }) {
        return <div className="mt-40 text-center">
            <h1 className="text-white text-3xl font-extrabold">{heading1}</h1>
            <h4 className="text-white text-2xl">{heading2}</h4>
            <h6 className="text-white">{heading3}</h6>
        </div>
    }
        ...
        <div className="bg-netflix h-screen">
            <div className="flex justify-around">
                ...
                <div className="flex items-center justify-end gap-5">
                    ...
                    {
                        lang !== "English" ? (<SignInLanguage title={"Iniciar sesión"} />) :
                            (<SignInLanguage title={"SignIn"} />)
                    }
                </div>
            </div>
            {
                lang !== "English" ? (<HeadingLanguage heading1="Películas, programas de TV y más ilimitados"
                    ...
                    (<HeadingLanguage heading1={"Unlimited movies, TV shows and more"} heading2={"Starts at ₹149. Cancel anytime."} heading3={"Ready to watch? Enter your email to create or restart your membership."} />)
            }
        </div>
